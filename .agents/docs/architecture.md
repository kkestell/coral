...
- Every answer Coral holds is bounded as it arrives — a GitHub response, comment body, or command output. The current diff is the exception; `.agents/docs/roadmap.md` puts its byte bound in "End-to-end byte budget."
