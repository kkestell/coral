...
from coral.github.marker import SENTINEL, is_mine, marker, reviewed_commit
...
def test_prose_that_merely_mentions_coral_is_not_corals() -> None:
    assert is_mine("Coral reviewed this and said coral:reviewed, apparently.") is False
